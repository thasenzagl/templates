...
% Template Setup (Uncomment the second line to add subtitles)
\setbeamertemplate{frametitle}{\insertframetitle \vskip-10pt \centerline{\rule{\textwidth}{0.4pt}}}
...
% Colors
\colorlet{myblue}{NavyBlue!60!black!82}
...
% Title Page
\title{ \bfseries \LARGE My Beamer Template}
\date{\vfill \bfseries A cool conference \\[4pt] June 1, 2018}	
