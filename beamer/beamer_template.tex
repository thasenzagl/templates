...
\setbeamertemplate{frametitle}{\color{myblue}\insertframetitle\par\vskip-6pt\hrulefill}
...
\usepackage[font={color=myblue, footnotesize}, labelfont={footnotesize}]{caption}
